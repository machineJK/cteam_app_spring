...
<body>
	...
	<form action="teacher_join" method="post">
		<input type="text" name="teacher_univ" placeholder="대학교" maxlength="10"/><br>
		<input type="text" name="teacher_major"  placeholder="전공" maxlength="10"/><br>
		<input type="text" name="teacher_univnum" placeholder="학번" maxlength="8" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/><br>
		...
		<input name="teacher_worktime" type="text" placeholder="몇 주" maxlength="1" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/><br>
		<input name="teacher_pay" type="text" placeholder="수업료" maxlength="2" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/><br>
		<textarea name="teacher_intro" placeholder="소개말"></textarea>
