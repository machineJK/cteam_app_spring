<%@page import="com.hanul.app.dto.MatchingDTO"%>
<%@page import="com.hanul.app.dto.StudentDTO"%>
...
<%		
	Gson gson = new Gson();
	String json = gson.toJson((ArrayList<MatchingDTO>)request.getAttribute("anAdminMatching"));
